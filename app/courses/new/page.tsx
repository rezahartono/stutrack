        ...
        <form action={createCourse} className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-800">
              <label htmlFor="day" className="block text-sm font-semibold text-slate-900 dark:text-slate-200 mb-1.5 flex items-center gap-2">
                <CalendarDays className="w-4 h-4 text-indigo-500" /> Hari Perkuliahan
              </label>
              <select
                id="day"
                name="day"
